...
![Server IP Discovery](images/Server%20IP%20Discovery.png)
*Figure 1: Identifying the assigned server IP address on the network.*

![Services Status Verification](images/Services%20Status%20Verification.png)
...
![Agent Installation Service Start](images/Agent%20Installation%20Service%20Start.jpg)
*Figure 3: Executing the agent installation and verifying successful service startup.*

![Active Agent Confirmation](images/Active%20Active%20Confirmation.jpg)
...
![Module Logs Stream](images/Module%20Logs%20Stream.jpg)
...
![Security Alert Detection](images/Security%20Alert%20Detection.jpg)
